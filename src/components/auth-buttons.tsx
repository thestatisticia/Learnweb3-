  ...
  return (
    <div className={`flex w-full flex-col gap-3 ${className}`}>
      ...
      >
        ...
        {pending ? "Opening…" : "Continue with Email"}
      </button>
...
export function StartLearningButton({
  ...
  return (
    <button
      ...
      className={`glow-border inline-flex items-center justify-center gap-2 rounded-full px-7 py-3.5 text-sm font-semibold text-white transition disabled:opacity-50 ${className}`}
    >
      {children}
    </button>
  );
